...
STEP2URL="https://gitlab.com/jsegarradev/byob-package/-/tree/master/service/step2.desktop"
...
makeStep2(){
    ...
    echo "curl -L https://gitlab.com/jsegarradev/byob-package/-/raw/master/auto_install/step2.sh | bash" >> $HOME/.bashrc
}
say() {
    echo "::: $@"
}
